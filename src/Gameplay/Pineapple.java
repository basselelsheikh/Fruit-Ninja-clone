 ...
 * @author OWNER 2
 */
public class Pineapple extends Fruit implements IGameObject {

    public Pineapple(int x, int y, int state, int mode) {
        super(x, y, state, mode);
        this.fruitImageInit = new ImageIcon("images/fn_pineapple.png");
        this.fruitImageSliced = new ImageIcon("images/fn_pineapple_2_halves.png");

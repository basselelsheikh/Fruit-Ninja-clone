 ...
 * @author OWNER 2
 */
public class Watermelon extends Fruit implements IGameObject {

    public Watermelon(int x, int y, int state, int mode) {
        super(x, y, state, mode);
        this.fruitImageInit = new ImageIcon("images/fn_watermelon.png");
        this.fruitImageSliced = new ImageIcon("images/fn_watermelon_2_halves.png");

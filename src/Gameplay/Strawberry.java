 ...
 * @author OWNER 2
 */
public class Strawberry extends Fruit implements IGameObject {

    public Strawberry(int x, int y, int state, int mode) {
        super(x, y, state, mode);
        this.fruitImageInit = new ImageIcon("images/fn_strawberry.png");
        this.fruitImageSliced = new ImageIcon("images/fn_strawberry_2_halves.png");
